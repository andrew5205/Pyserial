...
# Option 1
import serial.tools.list_ports
print(list(serial.tools.list_ports.comports()))         # [<serial.tools.list_ports_common.ListPortInfo object at 0x00000253F73B4C70>]
...
print(ports)          # [<serial.tools.list_ports_common.ListPortInfo object at 0x00000253F73B4C70>]
...
# COM3: Prolific USB-to-Serial Comm Port (COM3) [USB VID:PID=067B:2303 SER= LOCATION=1-2]
